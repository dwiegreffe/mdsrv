...
import { Clustal as _Clustal } from '../extensions/sequence-alignment/clustal';
import { Alignment as _Alignment } from '../extensions/sequence-alignment/alignments';
...
export namespace PluginStateObject {
    ...
    export namespace Alignment {
        export class Clustal extends Create<_Clustal>({ name: 'Clustal', typeClass: 'Object' }) { }
        export class Alignment extends Create<_Alignment>({ name: 'Alignment', typeClass: 'Object' }) { }
    }
}
