...
export const OpenFiles = StateAction.build({
    display: { name: 'Open Local Files', description: 'Load one or more files and optionally create default visuals' },
...
export const DownloadFile = StateAction.build({
    display: { name: 'Open Remote File', description: 'Load one or more file from an URL' },
    from: PluginStateObject.Root,
    params: (a, ctx: PluginContext) => {
