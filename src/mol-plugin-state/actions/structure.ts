...
const DownloadStructure = StateAction.build({
    ...
    display: { name: 'Open Remote Structure', description: 'Load a structure from the provided source and create its representation.' },
...
export const AddTrajectory = StateAction.build({
    display: { name: 'Assign Trajectory', description: 'Add trajectory from existing model/topology and coordinates.' },
    from: PluginStateObject.Root,
    params(a, ctx: PluginContext) {
