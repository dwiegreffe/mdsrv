...
import { MeasurementPlot } from '../../extensions/measurement-plot';
...
import { RemoteSession } from '../../extensions/remote-session';
import { SequenceAlignment } from '../../extensions/sequence-alignment';
import { ClustalProvider } from '../../extensions/sequence-alignment/format';
import { ServerXTCUpload } from '../../extensions/server-xtc-upload';
import { XTCStream } from '../../extensions/xtc-stream';
...
const CustomFormats = [
    ...
    ['clustal', ClustalProvider] as const,
];
...
const Extensions = {
    ...
    'remote-session': PluginSpec.Behavior(RemoteSession),
    'server-xtc-upload': PluginSpec.Behavior(ServerXTCUpload),
    'xtc-stream': PluginSpec.Behavior(XTCStream),
    'sequence-alignment': PluginSpec.Behavior(SequenceAlignment),
};
...
const DefaultViewerOptions = {
    ...
    layoutShowLog: true,
    layoutShowBottomExtension: true,
...
export class Viewer {
        ...
        const spec: PluginUISpec = {
            ...
            components: {
                ...
                controls: {
                    ...
                    extension: o.layoutShowBottomExtension ? undefined : 'none',
                },
    ...
    loadSessionFromUrl(url: string) {
        return PluginCommands.State.Snapshots.FetchSession(this.plugin, { url: url });
    }
