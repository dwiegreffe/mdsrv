...
export function getSchema(config: Config) {
  ...
  return {
    ...
    info: {
      ...
      description:
        "A file-backed PDB topology registry for modular MDsrv deployments.",
    },
    tags: [{ name: "Topology" }],
    paths: {
      [mapPath("api/v1/topology")]: {
        ...
        post: {
          tags: ["Topology"],
          summary:
            "Fetches a PDB file from a remote URL and stores it in the topology registry.",
          ...
          responses: {
            ...
            409: {
              description: "Topology id or file name already exists.",
              content: { "application/json": {} },
            },
          },
        },
      ...
      [mapPath("api/v1/topology/{id}")]: {
        put: {
          tags: ["Topology"],
          summary:
            "Uploads a PDB file directly and stores it under the given topology id.",
          ...
          parameters: [
            ...
            },
            {
              name: "fileName",
              in: "query",
              description: "Stored file name. Must end with .pdb.",
              required: false,
              schema: { type: "string" },
            },
          ],
        ...
        get: {
          tags: ["Topology"],
          summary:
            "Returns the stored PDB file content for the given topology id.",
          ...
          responses: {
            200: {
              description: "The PDB file content.",
              content: { "chemical/x-pdb": {} },
            },
            404: {
