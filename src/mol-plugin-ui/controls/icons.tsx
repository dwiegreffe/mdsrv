...
const _ClearAll = <svg width='24px' height='24px' viewBox='0 0 24 24'><path d='M5 13h14v-2H5v2zm-2 4h14v-2H3v2zM7 7v2h14V7H7z' /></svg>;
export function ClearAllSvg() { return _ClearAll; }
...
const _ShowChart = <svg width='24px' height='24px' viewBox='0 0 24 24'><path d='m3.5 18.49 6-6.01 4 4L22 6.92l-1.41-1.41-7.09 7.97-4-4L2 16.99z' /></svg>;
export function ShowChart() { return _ShowChart; }
